...
func TestMatchesIgnoreRule(t *testing.T) {
	tests := []struct {
		...
		{"match tag regex alternation", IgnoreRule{Tag: "CRON|systemd"}, "h", "kern", "err", "CRON", "msg", true},
		{"match tag regex wildcard", IgnoreRule{Tag: "my.*"}, "h", "kern", "err", "myapp", "msg", true},
		{"no match tag regex anchored", IgnoreRule{Tag: "^nginx$"}, "h", "kern", "err", "myapp", "msg", false},
...
func TestMatchesRewriteRule(t *testing.T) {
	tests := []struct {
		...
		{"match tag regex alternation", SeverityRewriteRule{Tag: "myapp|otherapp"}, "h", "kern", "info", "myapp", "msg", true},
		{"match tag regex wildcard", SeverityRewriteRule{Tag: "my.*"}, "h", "kern", "info", "myapp", "msg", true},
		{"no match tag regex anchored", SeverityRewriteRule{Tag: "^nginx$"}, "h", "kern", "info", "myapp", "msg", false},
